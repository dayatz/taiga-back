...
# INTRANET_TAIGA_USER_URL = 'http://localhost:8000/taiga_user/user/AbacusTech/'
INTRANET_TAIGA_USER_URL = 'http://ec2-54-201-41-149.us-west-2.compute.amazonaws.com:8080/taiga_user/user/AbacusTech/'
